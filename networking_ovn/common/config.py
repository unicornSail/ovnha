...
ovn_opts = [
    ...
    cfg.ListOpt('ovn_etcd_connection',
               default=[],
               help=_('The connection string for the etcd server.')),
    cfg.IntOpt('ovsdb_connection_timeout',
               default=60,
               help=_('Timeout in seconds for the OVSDB '
                      'connection transaction')),
    cfg.StrOpt('ovsdb_private_key_file',
               default=None,
               help=_('file with private key for connect ovsdb')),
    cfg.StrOpt('ovsdb_certificate_file',
               default=None,
               help=_('file with certificate for private key for connect ovsdb')),
    cfg.StrOpt('ovsdb_ca_cert_file',
               default=None,
               help=_('file with peer CA certificate for connect ovsdb')),
    ...
    cfg.StrOpt("ovn_l3_chassis_type",
               default=None,
               help=_('Schedule gateway router on only the specified type '
                      'chassis, and default on all chassis.')),
    cfg.StrOpt("vif_type",
...
def get_ovn_etcd_connection():
    return cfg.CONF.ovn.ovn_etcd_connection
...
def get_ovn_ovsdb_private_key_file():
    return cfg.CONF.ovn.ovsdb_private_key_file


def get_ovn_ovsdb_certificate_file():
    return cfg.CONF.ovn.ovsdb_certificate_file


def get_ovn_ovsdb_ca_cert_file():
    return cfg.CONF.ovn.ovsdb_ca_cert_file
...
def get_ovn_l3_chassis_type():
    return cfg.CONF.ovn.ovn_l3_chassis_type
